    ...
    const messages = [
      {
        ...
        body: `${streak} jours de suite — ne brise pas ta série !`,
      },
      {
        title: "📖 Mot du jour",
        body: "Un nouveau mot coranique t'attend. 5 minutes suffisent.",
      },
      {
        title: "🕌 Rappel Nour",
        body: "Comprends le Coran un mot à la fois. C'est le moment !",
      },
    ];
